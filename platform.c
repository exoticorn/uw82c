...
static void init_func_types(void) {
  ...
  func_types[15] = wasm_rt_register_func_type(1, 1, WASM_RT_I32, WASM_RT_F32);
  func_types[16] = wasm_rt_register_func_type(3, 1, WASM_RT_I32, WASM_RT_F32, WASM_RT_I32, WASM_RT_I32);
}

static f32 w2c_time(Z_env_instance_t*);
static u32 w2c_isButtonPressed(Z_env_instance_t*, u32);
static u32 w2c_isButtonTriggered(Z_env_instance_t*, u32);
static u32 w2c_random(Z_env_instance_t*);
static u64 w2c_random64(Z_env_instance_t*);
static f32 w2c_randomf(Z_env_instance_t*);
static void w2c_randomSeed(Z_env_instance_t*, u32);
static f32 w2c_fmod(Z_env_instance_t*, f32, f32);
static void w2c_cls(Z_env_instance_t*, u32);
static void w2c_setPixel(Z_env_instance_t*, u32, u32, u32);
static u32 w2c_getPixel(Z_env_instance_t*, u32, u32);
static void w2c_hline(Z_env_instance_t*, u32, u32, u32, u32);
static void w2c_rectangle(Z_env_instance_t*, f32, f32, f32, f32, u32);
static void w2c_rectangle_outline(Z_env_instance_t*, f32, f32, f32, f32, u32);
static void w2c_circle(Z_env_instance_t*, f32, f32, f32, u32);
static void w2c_circle_outline(Z_env_instance_t*, f32, f32, f32, u32);
static void w2c_line(Z_env_instance_t*, f32, f32, f32, f32, u32);
static void w2c_printChar(Z_env_instance_t*, u32);
static void w2c_printString(Z_env_instance_t*, u32);
static void w2c_printInt(Z_env_instance_t*, u32);
static void w2c_setTextColor(Z_env_instance_t*, u32);
static void w2c_setBackgroundColor(Z_env_instance_t*, u32);
static void w2c_setCursorPosition(Z_env_instance_t*, u32, u32);
static void w2c_playNote(Z_env_instance_t*, u32, u32);
static void w2c_endFrame(Z_env_instance_t*);
static f32 w2c_sndGes(Z_env_instance_t*, u32);
static u32 w2c_f31(Z_env_instance_t*, u32, u32, u32);
static void w2c_f32(Z_env_instance_t*, u32);
static void w2c_f33(Z_env_instance_t*, u32);
static void w2c_f34(Z_env_instance_t*);
static u32 w2c_f35(Z_env_instance_t*, u32, f32, u32);

static void init_globals(Z_env_instance_t* instance) {
...
static void init_memories(Z_env_instance_t* instance) {
...
static void init_data_instances(Z_env_instance_t *instance) {
}

static f32 w2c_time(Z_env_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  f32 w2c_f0, w2c_f1;
  w2c_i0 = 0u;
...
static u32 w2c_isButtonPressed(Z_env_instance_t* instance, u32 w2c_p0) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  w2c_i0 = 68u;
...
static u32 w2c_isButtonTriggered(Z_env_instance_t* instance, u32 w2c_p0) {
  FUNC_PROLOGUE;
...
static u32 w2c_random(Z_env_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
  u64 w2c_j0, w2c_j1;
...
static u64 w2c_random64(Z_env_instance_t* instance) {
  u64 w2c_l0 = 0;
  FUNC_PROLOGUE;
...
static f32 w2c_randomf(Z_env_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1, w2c_i2;
  f32 w2c_f0, w2c_f1;
  w2c_i0 = 1065353216u;
...
static void w2c_randomSeed(Z_env_instance_t* instance, u32 w2c_p0) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1, w2c_i2;
  u64 w2c_j0, w2c_j1;
  w2c_i0 = w2c_p0;
...
static f32 w2c_fmod(Z_env_instance_t* instance, f32 w2c_p0, f32 w2c_p1) {
  FUNC_PROLOGUE;
...
static void w2c_cls(Z_env_instance_t* instance, u32 w2c_p0) {
  u32 w2c_l1 = 0;
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1, w2c_i2;
  w2c_i0 = 0u;
...
static void w2c_setPixel(Z_env_instance_t* instance, u32 w2c_p0, u32 w2c_p1, u32 w2c_p2) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1, w2c_i2;
  w2c_i0 = w2c_p0;
  w2c_i1 = 320u;
...
static u32 w2c_getPixel(Z_env_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1, w2c_i2;
  w2c_i0 = w2c_p0;
  w2c_i1 = 320u;
...
static void w2c_hline(Z_env_instance_t* instance, u32 w2c_p0, u32 w2c_p1, u32 w2c_p2, u32 w2c_p3) {
...
static void w2c_rectangle(Z_env_instance_t* instance, f32 w2c_p0, f32 w2c_p1, f32 w2c_p2, f32 w2c_p3, u32 w2c_p4) {
...
static void w2c_rectangle_outline(Z_env_instance_t* instance, f32 w2c_p0, f32 w2c_p1, f32 w2c_p2, f32 w2c_p3, u32 w2c_p4) {
  u32 w2c_l5 = 0, w2c_l6 = 0, w2c_l7 = 0, w2c_l8 = 0;
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1, w2c_i2, w2c_i3;
  f32 w2c_f0, w2c_f1;
...
static void w2c_circle(Z_env_instance_t* instance, f32 w2c_p0, f32 w2c_p1, f32 w2c_p2, u32 w2c_p3) {
...
static void w2c_circle_outline(Z_env_instance_t* instance, f32 w2c_p0, f32 w2c_p1, f32 w2c_p2, u32 w2c_p3) {
  u32 w2c_l4 = 0, w2c_l5 = 0, w2c_l6 = 0, w2c_l7 = 0, w2c_l8 = 0, w2c_l9 = 0;
...
static void w2c_line(Z_env_instance_t* instance, f32 w2c_p0, f32 w2c_p1, f32 w2c_p2, f32 w2c_p3, u32 w2c_p4) {
  u32 w2c_l5 = 0;
...
static void w2c_printChar(Z_env_instance_t* instance, u32 w2c_p0) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  w2c_L0: 
    w2c_i0 = w2c_p0;
...
static void w2c_printString(Z_env_instance_t* instance, u32 w2c_p0) {
  u32 w2c_l1 = 0;
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  w2c_L0: 
...
static void w2c_printInt(Z_env_instance_t* instance, u32 w2c_p0) {
  u32 w2c_l1 = 0;
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1, w2c_i2, w2c_i3;
  w2c_i0 = 77823u;
...
static void w2c_setTextColor(Z_env_instance_t* instance, u32 w2c_p0) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
  w2c_i0 = w2c_p0;
...
static void w2c_setBackgroundColor(Z_env_instance_t* instance, u32 w2c_p0) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
  w2c_i0 = w2c_p0;
...
static void w2c_setCursorPosition(Z_env_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  u32 w2c_l2 = 0;
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1, w2c_i2, w2c_i3;
  w2c_i0 = w2c_p0;
...
static void w2c_playNote(Z_env_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  FUNC_PROLOGUE;
...
static void w2c_endFrame(Z_env_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  w2c_i0 = 68u;
  w2c_i1 = 68u;
...
static f32 w2c_sndGes(Z_env_instance_t* instance, u32 w2c_p0) {
      ...
      if (w2c_i0) {
        ...
        if (w2c_i0) {
          ...
          w2c_L9: 
            ...
            w2c_f2 = w2c_l51;
            w2c_i3 = 4294934529u;
            w2c_i1 = w2c_f35(instance, w2c_i1, w2c_f2, w2c_i3);
            w2c_i0 -= w2c_i1;
            w2c_l19 = w2c_i0;
            w2c_i0 = 0u;
            w2c_i1 = w2c_l19;
          ...
          w2c_L10: 
            ...
            w2c_f3 = w2c_l51;
            w2c_i4 = 4294934529u;
            w2c_i2 = w2c_f35(instance, w2c_i2, w2c_f3, w2c_i4);
            w2c_i1 -= w2c_i2;
            w2c_i2 = w2c_l13;
            w2c_i3 = w2c_l21;
            w2c_i2 -= w2c_i3;
...
static u32 w2c_f31(Z_env_instance_t* instance, u32 w2c_p0, u32 w2c_p1, u32 w2c_p2) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1, w2c_i2, w2c_i3, w2c_i4;
  w2c_i0 = w2c_p1;
  w2c_i1 = w2c_p2;
...
static void w2c_f32(Z_env_instance_t* instance, u32 w2c_p0) {
...
static void w2c_f33(Z_env_instance_t* instance, u32 w2c_p0) {
  u32 w2c_l1 = 0, w2c_l2 = 0, w2c_l3 = 0;
  FUNC_PROLOGUE;
...
static void w2c_f34(Z_env_instance_t* instance) {
...
static u32 w2c_f35(Z_env_instance_t* instance, u32 w2c_p0, f32 w2c_p1, u32 w2c_p2) {
...
/* export: 'time' */
f32 Z_envZ_time(Z_env_instance_t* instance) {
  return w2c_time(instance);
}

/* export: 'isButtonPressed' */
u32 Z_envZ_isButtonPressed(Z_env_instance_t* instance, u32 w2c_p0) {
  return w2c_isButtonPressed(instance, w2c_p0);
}

/* export: 'isButtonTriggered' */
u32 Z_envZ_isButtonTriggered(Z_env_instance_t* instance, u32 w2c_p0) {
  return w2c_isButtonTriggered(instance, w2c_p0);
}

/* export: 'random' */
u32 Z_envZ_random(Z_env_instance_t* instance) {
  return w2c_random(instance);
}

/* export: 'random64' */
u64 Z_envZ_random64(Z_env_instance_t* instance) {
  return w2c_random64(instance);
}

/* export: 'randomf' */
f32 Z_envZ_randomf(Z_env_instance_t* instance) {
  return w2c_randomf(instance);
}

/* export: 'randomSeed' */
void Z_envZ_randomSeed(Z_env_instance_t* instance, u32 w2c_p0) {
  return w2c_randomSeed(instance, w2c_p0);
}

/* export: 'fmod' */
f32 Z_envZ_fmod(Z_env_instance_t* instance, f32 w2c_p0, f32 w2c_p1) {
  return w2c_fmod(instance, w2c_p0, w2c_p1);
}

/* export: 'cls' */
void Z_envZ_cls(Z_env_instance_t* instance, u32 w2c_p0) {
  return w2c_cls(instance, w2c_p0);
}

/* export: 'setPixel' */
void Z_envZ_setPixel(Z_env_instance_t* instance, u32 w2c_p0, u32 w2c_p1, u32 w2c_p2) {
  return w2c_setPixel(instance, w2c_p0, w2c_p1, w2c_p2);
}

/* export: 'getPixel' */
u32 Z_envZ_getPixel(Z_env_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  return w2c_getPixel(instance, w2c_p0, w2c_p1);
}

/* export: 'hline' */
void Z_envZ_hline(Z_env_instance_t* instance, u32 w2c_p0, u32 w2c_p1, u32 w2c_p2, u32 w2c_p3) {
  return w2c_hline(instance, w2c_p0, w2c_p1, w2c_p2, w2c_p3);
}

/* export: 'rectangle' */
void Z_envZ_rectangle(Z_env_instance_t* instance, f32 w2c_p0, f32 w2c_p1, f32 w2c_p2, f32 w2c_p3, u32 w2c_p4) {
  return w2c_rectangle(instance, w2c_p0, w2c_p1, w2c_p2, w2c_p3, w2c_p4);
}

/* export: 'rectangle_outline' */
void Z_envZ_rectangle_outline(Z_env_instance_t* instance, f32 w2c_p0, f32 w2c_p1, f32 w2c_p2, f32 w2c_p3, u32 w2c_p4) {
  return w2c_rectangle_outline(instance, w2c_p0, w2c_p1, w2c_p2, w2c_p3, w2c_p4);
}

/* export: 'circle' */
void Z_envZ_circle(Z_env_instance_t* instance, f32 w2c_p0, f32 w2c_p1, f32 w2c_p2, u32 w2c_p3) {
  return w2c_circle(instance, w2c_p0, w2c_p1, w2c_p2, w2c_p3);
}

/* export: 'circle_outline' */
void Z_envZ_circle_outline(Z_env_instance_t* instance, f32 w2c_p0, f32 w2c_p1, f32 w2c_p2, u32 w2c_p3) {
  return w2c_circle_outline(instance, w2c_p0, w2c_p1, w2c_p2, w2c_p3);
}

/* export: 'line' */
void Z_envZ_line(Z_env_instance_t* instance, f32 w2c_p0, f32 w2c_p1, f32 w2c_p2, f32 w2c_p3, u32 w2c_p4) {
  return w2c_line(instance, w2c_p0, w2c_p1, w2c_p2, w2c_p3, w2c_p4);
}

/* export: 'printChar' */
void Z_envZ_printChar(Z_env_instance_t* instance, u32 w2c_p0) {
  return w2c_printChar(instance, w2c_p0);
}

/* export: 'printString' */
void Z_envZ_printString(Z_env_instance_t* instance, u32 w2c_p0) {
  return w2c_printString(instance, w2c_p0);
}

/* export: 'printInt' */
void Z_envZ_printInt(Z_env_instance_t* instance, u32 w2c_p0) {
  return w2c_printInt(instance, w2c_p0);
}

/* export: 'setTextColor' */
void Z_envZ_setTextColor(Z_env_instance_t* instance, u32 w2c_p0) {
  return w2c_setTextColor(instance, w2c_p0);
}

/* export: 'setBackgroundColor' */
void Z_envZ_setBackgroundColor(Z_env_instance_t* instance, u32 w2c_p0) {
  return w2c_setBackgroundColor(instance, w2c_p0);
}

/* export: 'setCursorPosition' */
void Z_envZ_setCursorPosition(Z_env_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  return w2c_setCursorPosition(instance, w2c_p0, w2c_p1);
}

/* export: 'playNote' */
void Z_envZ_playNote(Z_env_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  return w2c_playNote(instance, w2c_p0, w2c_p1);
}

/* export: 'endFrame' */
void Z_envZ_endFrame(Z_env_instance_t* instance) {
  return w2c_endFrame(instance);
}

/* export: 'sndGes' */
f32 Z_envZ_sndGes(Z_env_instance_t* instance, u32 w2c_p0) {
  return w2c_sndGes(instance, w2c_p0);
}

static void init_instance_import(Z_env_instance_t* instance, struct Z_env_instance_t* Z_env_instance){
...
void Z_env_instantiate(Z_env_instance_t* instance, struct Z_env_instance_t* Z_env_instance) {
  assert(wasm_rt_is_initialized());
...
void Z_env_free(Z_env_instance_t* instance) {
}
